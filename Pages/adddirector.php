...
if ( isset( $_POST['submit'] ) ) {
    ...
    if ( $file_type != "image/png" && $file_type != "image/jpeg" ) {
		...
		move_uploaded_file( $file_temp, "../Images/directors/".$file_name );
	}
	...
	if ( !$error ) {
        ...
        $directorInsert="INSERT INTO director (firstName, lastName, picture_name) 
        VALUES ('$fName','$lName','$file_name')";
		$result = mysqli_query($connection, $directorInsert);
...
<head>
  ...
  <li class="nav-item">
    <a class="nav-link active" href="adddirector.php">Add a director</a>
  </li>
  <li class="nav-item">
